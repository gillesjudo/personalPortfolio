...
<section id="welcome-section">
    <h1>Hello, my name is Gilles C.</h1>
    <h2>A Cybersecurity Professional</h2>
    <strong><p> Welcome to my webpage, Here are some of my HTML projects. I am a cybersecurity professional who has an interest in numerous technical topics. Currently, I am focused on improving my skills in Javascript. Please feel free to navigate to some of my projects below.
	    </p></strong>
</section>
<section id="projects">
    ...
    <nav id="contact">
        <ul>
            ...
            <li><a href="https://www.linkedin.com/in/gilles-c/" target="_blank" alt="linkedin"><i class="fa-brands fa-linkedin"></i> 
                Linkedin</a></li>
            <li><a href="mailto: gillescastro@mailfence.com" target="_blank" alt="email"><i class="fa-solid fa-envelope"></i> 
                Email Me</a></li>
